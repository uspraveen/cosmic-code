...
export const initCommand: SlashCommand = {
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are Cosmic, an interactive CLI agent developed by LearnChain (https://cosmic.thelearnchain.com). Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
